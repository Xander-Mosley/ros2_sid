...
from ros2_sid.drone_connection import DroneCommander

class PubInputSignals(Node):
    def __init__(self, ns=''):
        super().__init__('excitation_node')
        self.drone1 = DroneCommander('udpin:127.0.0.1:14552')
        self.switch: int = 0
        self.switch_channel: int = 5
        self.switch_threshold: float = 1550
    ...
    def logic_loop(self) -> None:
        ...
        print("Waiting")
        print(self.drone1.check_rc_channel(self.switch_channel))
        print("Checked")
        if (self.switch == 1):
